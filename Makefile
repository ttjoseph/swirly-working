...
pkgdatadir = $(datadir)/swirly
pkglibdir = $(libdir)/swirly
pkgincludedir = $(includedir)/swirly
...
EXTRA_DIST = swirly.kdevprj AUTHORS COPYING INSTALL README TODO swirly.lsm ChangeLog 
